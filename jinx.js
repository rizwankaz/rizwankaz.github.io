...
async function checkPassword() {
    ...
    try {
        const response = await fetch('https://1b62-2607-fb91-3215-5ae9-55da-628e-af47-a61f.ngrok-free.app/verify-password', {
            method: 'POST',
            headers: {
...
async function loadCounters() {
    try {
        const response = await fetch('https://1b62-2607-fb91-3215-5ae9-55da-628e-af47-a61f.ngrok-free.app/counters');
...
async function incrementCounter(name) {
    ...
    try {
        await fetch('https://1b62-2607-fb91-3215-5ae9-55da-628e-af47-a61f.ngrok-free.app/counter', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
